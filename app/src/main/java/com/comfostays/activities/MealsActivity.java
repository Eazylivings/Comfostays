    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(getArguments().getInt(ARG_SECTION_NUMBER)==1){
                ...
                View rootView = inflater.inflate(R.layout.fragment_meals_breakfast, container, false);
                return rootView;

            }else{

                View rootView = inflater.inflate(R.layout.fragment_meals_lunch_dinner, container, false);
                return rootView;
