...
public class OccupancyActivity extends AppCompatActivity {
    ...
    String[] list = new String[] { "Occupied", "Unoccupied"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            commonFunctionality.setTitleBar(R.id.backButton, R.id.titleBar, R.id.homeButton, Constants.TITLE_OCCUPANCY);
            ...
            if(isCurrentOccupancyCheckedBoxChecked && monthAndYearRangeRelativeLayout!=null && currentOccupancyCheckBox!=null){
                ...
                monthAndYearRangeRelativeLayout.setVisibility(View.GONE);
            }
            ...
            if(isOccupancyLoadedForFirstTime && linearLayout!=null){
                ...
                upperLevelRoomOccupancyCoordinates=sharedPreference.getStringValueFromSharedPreference(Constants.INTENT_ROOM_OCCUPANCY_UPPER_LEVEL_COORDINATES);
    ...
    public void onClickGetOccupancy(View view){
        ...
        if(isCurrentOccupancyCheckedBoxChecked){
            ...
            if(fromYear<=toYear){
                ...
                commonFunctionality.generatePopupMessage(Constants.ALERT_MESSAGE,Constants.POPUP_MESSAGE_SELECT_CORRECT_YEAR);
            }
        }
    }
    ...
    public void onClickGetCurrentOccupancy(View view){
        ...
        if(checkBox!=null && monthAndYearRangeRelativeLayout!=null &&checkBox.isChecked()){
            ...
            //monthAndYearRangeRelativeLayout.setVisibility(View.VISIBLE);
