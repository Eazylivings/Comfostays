...
import com.comfostays.activities.buildingsetup.CaptureOtherDetailsActivity;
...
public class EditMealsActivity extends AppCompatActivity {
        ...
        if(toolbar!=null) {
            toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    commonFunctionality.onBackPressed(MealsActivity.class);
                }
            });
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_edit_meals, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_edit_meals, container, false);
