...
public class TenantsDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            //listOfTenantDetailsVO=(ArrayList<TenantDetailsVO>)intent.getSerializableExtra(Constants.INTENT_LIST_OF_TENANT_DETAILS_VO);
            //int selection=intent.getIntExtra(Constants.INTENT_TENANT_SELECTION,0);
            ...
            commonFunctionality=new CommonFunctionality(getApplicationContext(),this);
            commonFunctionality.setTitleBar(R.id.backButton,R.id.titleBar,R.id.homeButton, Constants.TITLE_TENANTS_DETAILS);
