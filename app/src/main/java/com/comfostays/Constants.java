...
public class Constants {
    ...
    public static final String INTENT_CAPTURE_OTHER_DETAILS_FACILITIES_DETAILS="captureOtherDetailsFacilitiesDetails";
    ...
    public static final String INTENT_ROOM_OCCUPANCY_UPPER_LEVEL_SELECTED_INPUTS="upperLevelRoomOccupancySelectedInputs";
    ...
    public static final String ALERT_WARNING="Wrong Credentials";
    ...
    public static final String ALERT_BOX_POSITIVE_HEADING_OFFERING_MEALS="Add meals";

    public static final String POPUP_MESSAGE_EMPTY_INPUT="Please enter some value";
    ...
    public static final String POPUP_MESSAGE_PASSWORD_RESET="An Email have been sent with new password. Please login with new password.";
    ...
    public static final String ACTION_GET_LIST_OF_TENANTS="getListOfTenantDetailsVO";
    ...
    public static final String AUTHENTICATION_USER_DETAILS_FETCHED_FAIL="User Details not fetched";

    public static final String AUTHENTICATION_EXISTING_USER_SUCCESS="User Already Present";
    public static final String AUTHENTICATION_EXISTING_USER_FAIL="User Not Present";

    public static final String URL_LOGIN="";
    public static final String URL_CUSTOMER_REGISTER="";
    public static final String URL_OWNER_REGISTER="";
    ...
    public static final String EXCEPTION_RESET_PASSWORD="Something wrong happened while resetting password. Please tey again after sometime";
    public static final String EXCEPTION_LOGIN="";
    ...
    public static final String TITLE_ROOM_OCCUPANCY="Room Occupancy";
    public static final String TITLE_OCCUPANCY="Occupancy";
    public static final String TITLE_NOTIFICATIONS="Notifications";
    public static final String TITLE_MEALS="Meals";
    public static final String TITLE_FACILITIES_PROVIDED="Facilities Provided";
    public static final String TITLE_COST_AND_CHARGES="Cost and Charges";
    public static final String TITLE_FINAL_PORTFOLIO="Final Portfolio";
    public static final String TITLE_VIEW_ADDED_ROOMS="View added rooms";
    ...
    public static final String TITLE_ADD_MEAL_SCHEDULE="Add Meal Schedule";
    ...
    public static final String EXCEPTION_NOTIFICATIONS_ACTIVITY="Exception occurred at Notifications";
    public static final String EXCEPTION_SET_BUILDING_LAYOUT_ACTIVITY="Exception occurred at Set Building Layout";
    public static final String EXCEPTION_ROOM_CONFIGURATION_ACTIVITY="Exception occurred at Room Configuration";
    ...
    public static final String ACTIVITY_COST_AND_CHARGES ="Cost and Charges";
